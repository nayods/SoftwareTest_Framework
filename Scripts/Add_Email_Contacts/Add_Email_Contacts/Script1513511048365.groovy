...
WebUI.setText(findTestObject('AddContacts_objects/Page_Veridone Webmail  Contacts (1)/input__firstname'), 'Johnnast')

WebUI.setText(findTestObject('AddContacts_objects/Page_Veridone Webmail  Contacts (1)/input__surname'), 'Summers')

WebUI.setText(findTestObject('AddContacts_objects/Page_Veridone Webmail  Contacts (1)/input__email'), 'john.summers@boxmail.com')
